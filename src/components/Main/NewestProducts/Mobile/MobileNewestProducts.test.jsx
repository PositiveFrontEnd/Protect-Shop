...
import MobileNewestProducts from "./MobileNewestProducts";
import { BrowserRouter } from "react-router-dom";
import configureStore from "redux-mock-store";
import thunk from "redux-thunk";

describe("Тестування компонента  MobileNewestProducts", () => {
    test("Знімок", () => {
        ...
        const mobileNewestProducts = render(
            <Provider store={store}>
                <BrowserRouter>
                    <MobileNewestProducts />
                </BrowserRouter>
            </Provider>
        );

        expect(mobileNewestProducts).toMatchSnapshot();
    });
});
