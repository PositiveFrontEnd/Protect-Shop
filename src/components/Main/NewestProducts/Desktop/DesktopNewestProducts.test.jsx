...
import DesktopNewestProducts from "./DesktopNewestProducts";
import { BrowserRouter } from "react-router-dom";
import configureStore from "redux-mock-store";
import thunk from "redux-thunk";

describe("Тестування компонента  DesktopNewestProducts", () => {
    test("Знімок", () => {
        ...
        const desktopNewestProducts = render(
            <Provider store={store}>
                <BrowserRouter>
                    <DesktopNewestProducts />
                </BrowserRouter>
            </Provider>
        );

        expect(desktopNewestProducts).toMatchSnapshot();
    });
});
