...
const Comment = ({ firstName, lastName, comment, likes, status,id ,commentAdmin}) => {
  ...
  return (
    <div className="comments__content__item">
      ...
      <div className="item__main">
       ...
       {status && (  <button onClick={openInput} className="main__button__answer">Answer</button>)}
      </div>
      {isInput && (<input 
      ...
      {commentAdmin &&
        ...
        <p> <strong>administrator</strong> <AdminSvg/></p>
        <p className="answerAdmin__user__name"> {firstName} {lastName}</p>
        <p>{commentAdmin}</p>
        </div>
