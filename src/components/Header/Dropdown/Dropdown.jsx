    ...
    <div className="dropdown" onClick={stopClick}>
      ...
      <div className="dropdown__search">
        ...
        <form onSubmit={handleSubmit}>
          <input
            className="dropdown__search__title"
            type="text"
            name="search"
            placeholder="SEARCH"
            value={inputText}
      ...
      <div className="dropdown__contacts">
        <div className="dropdown__contacts__item" onClick={modalChange}>
          <PhoneIncomingB />
          <p className="dropdown__contacts__text" onClick={actionDropdown}>
            Call me out
          </p>
        </div>
        <div className="dropdown__contacts__item">
          <PhoneB />
          <a className="dropdown__contacts__text" href="tel:+380505000096">
            +380(50) 500 00 96
          </a>
        </div>
        <div className="dropdown__contacts__item">
          <Time />
          <p className="dropdown__contacts__text">Mon-Sun: 11:00 – 20:00</p>
        </div>
      </div>
