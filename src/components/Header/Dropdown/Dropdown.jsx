    ...
    return (
        <div className='dropdown' onClick={stopClick}>
            ...
            <nav className='dropdown__menu'>
                <Link className='dropdown__list' to='/catalogue?status=sell'
                >sale</Link>
                <Link className='dropdown__list' to='/catalogue?status=new'
                >new</Link>
                <NavLink className='dropdown__list' onClick={actionDropdown}
                    to='/catalogue'>catalogue</NavLink>
                <NavLink className='dropdown__list' onClick={actionDropdown} to='/shops'>shops</NavLink>
                <NavLink className='dropdown__list' onClick={actionDropdown} to='/about-us'>about us</NavLink>
            </nav>
