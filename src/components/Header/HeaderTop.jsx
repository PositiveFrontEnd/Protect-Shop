        ...
        <>
            <div className='header__top container'>
                ...
                <div className='header__nav'>
                    ...
                    {isSearch ? <Link to="/catalogue"><Close/></Link>
                        : <Link to='/search-'><SearchW/></Link>}

                    {(!isAccount && isAdmin) ? <Link to="/account"><Mail/></Link>
                        : ((!isAccount && !isAdmin) ? <Link to="/account"><Account/></Link>
                                : <Link to="/catalogue"><Close/></Link>
                        )}

                    {isFavorites ? <Link to="/catalogue"><Close/></Link>
                        : <><Link to="/favorites"><Favorite/>
                    ...
                    {isCart ? <Link to="/catalogue"><Close/></Link>
                        : <><Link to={isAdmin ? "#" : "/cart"}><Cart/>
