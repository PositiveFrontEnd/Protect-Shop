...
const ModalDeleteLetter = ({ isOpen, onclick, firstClick, secondaryClick }) => {
    return (
        <>
            <ModalWrapper isOpen={isOpen}>
                <Modal>
                    ...
                    <ModalBody>
                        <p className="modal__body-title title__logOut">Are you sure you want to delete letter?</p>
                        <ModalFooter
...
ModalDeleteLetter.defaultProps = {
    onclick: () => { },
    isOpen: () => { }
}

ModalDeleteLetter.propTypes = {
    onclick: PropTypes.func,
    isOpen: PropTypes.func,
}

export default ModalDeleteLetter