...
import { selectorImportantLetters, selectorLetterToUpdate } from "../../../store/selectors";
import { useNavigate } from "react-router-dom";
import cn from "classnames";

const LetterItemCard = ({ orderNo, dateItem, phone, question, name, handleOpenOrder, status, handleAddImportant, id, letter }) => {
