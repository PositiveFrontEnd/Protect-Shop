        ...
        <Form>
            <div className="filter__box">
                <div className="filter__title">
                    <div className="filter__title__box">
                        <FilterSvg />
                        <h6 className="filter__title__item">filter</h6>
                    </div>
                </div>
                ...
                <div className="filter__item"  >
                    ...
                    {!isArrowPrice && <div className="price-slider">
                        ...
                        />
                        <div className="price__slider"> <p> {values.priceRange[0]} $  </p> <p>{values.priceRange[1]} $</p></div>
            ...
            <div className="filter__button__box">
                <Button white type="submit" click={() => { handleSubmit, scrollToTop() }} className="button__submitFilter-white">Submit</Button>
                <Button white className="button__cleanFilter-white" click={() => { resetForm(), clearForm(), scrollToTop() }}>Clear</Button>
            </div>
        </Form>
    )
}
